...
(function(PhaserInput) {
  ...
  var InputField = (function(_super) {
    ...
    function InputField(game, x, y, inputOptions) {
      ...
      _this.inputOptions.width = typeof inputOptions.width === 'number'
        ? inputOptions.width
        : 150;
      _this.inputOptions.padding = typeof inputOptions.padding === 'number'
      ...
      _this.inputOptions.forceCase = inputOptions.forceCase
        ...
        : ForceCase.none;
      _this.inputOptions.borderRadius = typeof inputOptions.borderRadius ===
        'number'
        ? inputOptions.borderRadius
        : 0;
      _this.inputOptions.height = typeof inputOptions.height === 'number'
        ? inputOptions.height
        : 14;
      _this.inputOptions.fillAlpha = inputOptions.fillAlpha === undefined
        ? 1
        : inputOptions.fillAlpha;
    ...
    InputField.prototype.setCaretOnclick = function(e) {
      var localX = this.text.toLocal(new PIXI.Point(e.x, e.y), this.game.world)
        .x;
      if (
